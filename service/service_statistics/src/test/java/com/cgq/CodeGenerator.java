...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        String pwd = "C:\\Users\\86173\\IdeaProjects\\guli_parent\\service\\service_statistics";
        //设置生成路径
        gc.setOutputDir("C:\\Users\\86173\\IdeaProjects\\guli_parent\\service\\service_statistics" + "/src/main/java");
        //生成作者
        gc.setAuthor("cgq");
        //生成代码是否要开所在文件夹
        gc.setOpen(false);
